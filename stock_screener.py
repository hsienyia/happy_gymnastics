...
def get_reliable_name_map():
    backup_names = {
        ...
        "3035": "智原", "3363": "上詮", "4979": "華星光", "3081": "聯亞", "3450": "聯鈞", "3163": "波若威", "6451": "訊芯-KY", "4908": "前鼎", "6442": "光聖", "2345": "智邦", "6643": "M31", "6462": "神盾", "6533": "晶心科",
...
# 自動檢查：如果現在時間符合時刻表，就自動設 trigger_scan 為 True
if any(current_hm == t or (now_time.minute == int(t.split(":")[1])+1 and now_time.hour == int(t.split(":")[0])) for t in target_times):
    trigger_scan = True
                ...
                for idx, row in display_df.reset_index(drop=True).iterrows():
                    ...
                    with st.container(border=True):
                        ...
                        with st.expander("🔍 財報與價值評估詳情"):
                            ...
                            r_type = row['風險']
                            if "🟢" in r_type:
                                st.success("**進場：** 🏆 核心買點。建議佈局 **40-50%** 資金 (吸籌力太低要問ai，權值.高價股 35分 ，低價股 40分 是鐵律)。")
